...
# $cc = Get-ChildItem ..\posh-maven -Recurse -File -Include *.ps1 -Exclude @("*.Tests.ps1", "Test.ps1", "Install.ps1", "Deploy.ps1")
...
# }
Write-Warning "Tests are skipped due to migration issues!"